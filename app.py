    ...
    if st.button('Prever Obesidade', key='predict_button'):
        if model is not None:
            ...
            features_to_visualize = {
                ...
                'transporte': {"pergunta": "Seu meio de transporte principal envolve caminhada ou bicicleta? ", "tipo": "radio", "opcoes": {0: 'Sim', 1: 'Não'}}, # Corrected: Added missing closing brace
            }
